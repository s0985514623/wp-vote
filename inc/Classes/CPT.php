...
final class CPT
{
    ...
    public function register_cpt(): void
    {
        ...
        $labels = [
            'name'                     => \esc_html__('市調', 'wp_vote'),
            'singular_name'            => \esc_html__('市調', 'wp_vote'),
            'add_new'                  => \esc_html__('新增市調', 'wp_vote'),
            'add_new_item'             => \esc_html__('新增市調', 'wp_vote'),
            'edit_item'                => \esc_html__('編輯市調', 'wp_vote'),
            'new_item'                 => \esc_html__('新市調', 'wp_vote'),
            'view_item'                => \esc_html__('查看市調', 'wp_vote'),
            'view_items'               => \esc_html__('查看市調', 'wp_vote'),
            'search_items'             => \esc_html__('搜尋市調', 'wp_vote'),
            'not_found'                => \esc_html__('Not Found 市調', 'wp_vote'),
            'not_found_in_trash'       => \esc_html__('Not found in trash 市調', 'wp_vote'),
            'parent_item_colon'        => \esc_html__('Parent item 市調', 'wp_vote'),
            'all_items'                => \esc_html__('全部市調', 'wp_vote'),
            'archives'                 => \esc_html__('市調', 'wp_vote'),
            'attributes'               => \esc_html__('市調', 'wp_vote'),
            ...
            'menu_name'                => \esc_html__('市調列表', 'wp_vote'),
